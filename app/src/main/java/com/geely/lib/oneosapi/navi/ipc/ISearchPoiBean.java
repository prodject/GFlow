...
public class ISearchPoiBean implements Parcelable {
    public static final Parcelable.Creator<ISearchPoiBean> CREATOR = new Parcelable.Creator<ISearchPoiBean>() { // from class: com.geely.lib.oneosapi.navi.ipc.ISearchPoiBean.1
    ...
    protected ISearchPoiBean(Parcel in) {
