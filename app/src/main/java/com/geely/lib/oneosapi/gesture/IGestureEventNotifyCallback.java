...
public interface IGestureEventNotifyCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGestureEventNotifyCallback {
        ...
        static final int TRANSACTION_onGestureNotify = 2;
        ...
        public static IGestureEventNotifyCallback asInterface(IBinder obj) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IGestureEventNotifyCallback)) {
                return (IGestureEventNotifyCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IGestureEventNotifyCallback {
