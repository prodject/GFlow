...
public interface IAirConditionerInfo extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAirConditionerInfo {
        ...
        static final int TRANSACTION_getTemperature = 2;
        static final int TRANSACTION_getWindSpeed = 4;
        ...
        public static IAirConditionerInfo asInterface(IBinder obj) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IAirConditionerInfo)) {
                return (IAirConditionerInfo) queryLocalInterface;
            }
        ...
        private static class Proxy implements IAirConditionerInfo {
