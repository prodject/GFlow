...
public class LynkData implements Parcelable {
    public static final Parcelable.Creator<LynkData> CREATOR = new Parcelable.Creator<LynkData>() { // from class: com.geely.lib.oneosapi.recommendation.bean.lynk.LynkData.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public LynkData createFromParcel(Parcel in) {
            return new LynkData(in);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public LynkData[] newArray(int size) {
            return new LynkData[size];
        }
    };
    private String buttonName;
    private String cardType;
    private LynkContentBean cpspContent;
    ...
    protected LynkData(Parcel in) {
        ...
        this.cpspContent = (LynkContentBean) in.readParcelable(LynkContentBean.class.getClassLoader());
    ...
    public LynkContentBean getCpspContent() {
        return this.cpspContent;
    }

    public void setCpspContent(LynkContentBean cpspContent) {
