...
public interface IGetOwnerVideoWallpaperCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetOwnerVideoWallpaperCallback {
        ...
        static final int TRANSACTION_getOwnerVideoWallpaperCallback = 1;
        ...
        public static IGetOwnerVideoWallpaperCallback asInterface(IBinder obj) {
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IGetOwnerVideoWallpaperCallback)) {
                return (IGetOwnerVideoWallpaperCallback) queryLocalInterface;
            }
        ...
        private static class Proxy implements IGetOwnerVideoWallpaperCallback {
