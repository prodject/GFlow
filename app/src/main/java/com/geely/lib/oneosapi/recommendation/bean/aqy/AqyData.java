...
public class AqyData implements Parcelable {
    public static final Parcelable.Creator<AqyData> CREATOR = new Parcelable.Creator<AqyData>() { // from class: com.geely.lib.oneosapi.recommendation.bean.aqy.AqyData.1
