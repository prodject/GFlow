...
public class SettingsActivity extends Activity {
    ...
    private LinkedHashMap<String, int[]> buildDiagnosticsGroups() {
        ...
        groups.put("ADAS", resolveFunctionIds(
                "ADAS_AEB", "ADAS_FCW", "ADAS_FCW_SENSITIVITY", "ADAS_LKA", "ADAS_LDW", "ADAS_RCW", "ADAS_ELKA",
                ...
                "ADAS_SPEED_LIMIT_WARNING_OFFSET", "ADAS_NOP_SPEED_LIMIT_WARNING_OFFSET",
        ...
        groups.put("Ambience / DayMode", resolveFunctionIds(
                ...
                "DAYMODE_ELECTRIC_REAR_VIEW_MIRROR", "DAYMODE_BRIGHTNESS_DAYMODE", "DAYMODE_BRIGHTNESS_SCREEN", "DAYMODE_CUSTOM_DAY_TIME",
