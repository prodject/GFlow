...
public class DvrService extends BaseForegroundService {
    ...
    private boolean startCameraSegment(String source) {
        ...
        try {
            ...
            android.util.Log.e("GFlowDvr", "camera segment failed " + source, e);
            stopActiveSegment();
            return false;
        }
    }
    ...
    private boolean startEvsScreenRecordSegment(String source) {
        ...
        try {
            ...
            if (!open.success) android.util.Log.w("GFlowDvr", open.message);
            ...
            android.util.Log.e("GFlowDvr", "EVS screenrecord failed " + source, e);
            stopActiveSegment();
            return false;
        }
    }
    ...
    private void createRecordingSession() {
        try {
            ...
            cameraDevice.createCaptureSession(Collections.singletonList(surface), new CameraCaptureSession.StateCallback() {
                @Override public void onConfigured(CameraCaptureSession session) {
                    ...
                    try {
                        ...
                        android.util.Log.e("GFlowDvr", "record start failed", e);
                        stopActiveSegment();
                    }
                }
            ...
            android.util.Log.e("GFlowDvr", "session failed", e);
            stopActiveSegment();
        }
    }
    ...
    private void ensureRecorderThread() {
        ...
        recorderThread = new HandlerThread("GFlowDvrRecorder");
    ...
    private void writeMarkerSegments() {
        ...
        for (String cameraId : DvrArchive.selectedCameras(this)) {
            ...
            try (FileOutputStream out = new FileOutputStream(f)) {
                ...
                android.util.Log.e("GFlowDvr", "segment error cam" + cameraId, e);
            }
        }
    }
}
