...
public class LowSpeedCameraService extends BaseForegroundService {
    static final String ACTION_START = "com.prodject.gcontrol.LOW_SPEED_CAMERA_START";
    static final String ACTION_STOP = "com.prodject.gcontrol.LOW_SPEED_CAMERA_STOP";
    ...
    @Override protected String title() { return "GControl low speed cameras"; }
