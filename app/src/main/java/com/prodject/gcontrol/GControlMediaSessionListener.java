...
public class GControlMediaSessionListener extends NotificationListenerService {
    ...
    @Override public void onListenerConnected() {
        ...
        if (manager != null) {
            android.content.ComponentName cn = new android.content.ComponentName(this, GControlMediaSessionListener.class);
    ...
    private void publish(MediaController controller) {
        ...
        android.util.Log.i("GControlMedia", controller.getPackageName() + " "
